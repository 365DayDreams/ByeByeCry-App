                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (_) => ListenMixSound(
                                      mixMusicModelId: snapshot.data!["id"],
                                      onPressed: () async {
                            ...
                            setData() {
                              if (mounted) {
                                ref
                                    ...
                                    .setMixPlaylistMusicId(setMixPlaylistId: snapshot.data!["id"]);
                              }
                              if (mounted) {
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child:
                                      Text("Now Playing ${getTitleName(snapshot.data!["type"])}",style: TextStyle(
